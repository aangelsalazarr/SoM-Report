...
output_dir = '.\jpm_economic_update'
...
eoUrl = 'https://am.jpmorgan.com/content/dam/jpm-am-aem/americas/us/en/insights/market-insights/wmr/economic_update.pdf'

response = requests.get(eoUrl)

file = open(r'.\report_processing_log\jpmEconMonitorLogger.txt', 'a')
